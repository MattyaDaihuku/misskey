...
>
	<header :class="$style.header">
		...
		<div :class="$style.headerRight">
			...
			<button v-click-anime v-tooltip="i18n.ts._visibility.disableFederation" :disabled="!localOnly && reply" class="_button" :class="[$style.headerRightItem, { [$style.danger]: localOnly }]" :disabled="channel != null || visibility === 'specified'" @click="toggleLocalOnly">
