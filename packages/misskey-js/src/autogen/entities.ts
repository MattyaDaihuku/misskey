...
export type ChannelsFollowersRequest = operations['channels___followers']['requestBody']['content']['application/json'];
export type ChannelsFollowersResponse = operations['channels___followers']['responses']['200']['content']['application/json'];
...
export type NotesFloaterRequest = operations['notes___floater']['requestBody']['content']['application/json'];
export type NotesFloaterResponse = operations['notes___floater']['responses']['200']['content']['application/json'];
...
export type NotesYamiTimelineRequest = operations['notes___yami-timeline']['requestBody']['content']['application/json'];
export type NotesYamiTimelineResponse = operations['notes___yami-timeline']['responses']['200']['content']['application/json'];
...
export type VoiceChatCreateRoomRequest = operations['voice-chat___create-room']['requestBody']['content']['application/json'];
export type VoiceChatCreateSessionRequest = operations['voice-chat___create-session']['requestBody']['content']['application/json'];
export type VoiceChatEndSessionRequest = operations['voice-chat___end-session']['requestBody']['content']['application/json'];
export type VoiceChatGetRoomRequest = operations['voice-chat___get-room']['requestBody']['content']['application/json'];
export type VoiceChatInviteUserRequest = operations['voice-chat___invite-user']['requestBody']['content']['application/json'];
export type VoiceChatJoinSessionRequest = operations['voice-chat___join-session']['requestBody']['content']['application/json'];
export type VoiceChatManageTracksRequest = operations['voice-chat___manage-tracks']['requestBody']['content']['application/json'];
export type VoiceChatRenegotiateRequest = operations['voice-chat___renegotiate']['requestBody']['content']['application/json'];
export type VoiceChatStartSessionRequest = operations['voice-chat___start-session']['requestBody']['content']['application/json'];
